    ...
    <div className="bg-[#1B0F19] w-full min-h-[50vh] flex items-center justify-center px-4 py-10 md:py-10">
      ...
      <div className="w-full sm:w-[85%] md:w-[85%] lg:w-[85%] xl:w-[60%] flex flex-col">
        ...
        <div className="relative w-full  mb-20 overflow-hidden mt-6 sm:mt-10">
          ...
          <img src={heroImg} alt="Hero Section" className="hidden xl:block w-full h-auto object-cover rounded-xl" />

          {/* MOBILE IMAGE */}
          <img src={heroMobile} alt="Hero Mobile" className="block xl:hidden w-full h-auto object-cover rounded-xl" />
          ...
          ">
            ...
            <button className="bg-white px-3 py-2 sm:px-4 rounded-lg 
